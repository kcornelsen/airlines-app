    ...
    <div class="col-12 wrapper">
      <div class="heading">
        ...
        <div class="loyalty__heading--tier">
          ...
          <div
            class="q-subtitle text-bold loyalty__heading-tier-number"
          >{{ Number(loyalty.membershipNumber).toLocaleString("en") }}</div>
        </div>
      </div>
      <div class="wrapper">
        <div class="row loyalty__progress">
          <div class="col-7 loyalty__progress--points">
            <div class="q-display-1">{{ Number(loyalty.points).toLocaleString("en") }}</div>
            ...
            <q-list highlight no-border class="q-pa-none q-ml-md" link>
              <a @click="choosePreference('diet')">
                <q-item class="q-pa-none q-mt-md profile__preferences-option">
                  ...
                  <q-item-main class="text-bold q-title q-ml-md" label="Dietary requirements"/>
                </q-item>
              </a>
              <a @click="choosePreference('luggage')">
                <q-item class="q-pa-none q-mt-md profile__preferences-option">
                  <q-icon name="tune" size="2.6rem"/>
                  <q-item-main class="text-bold q-title q-ml-md" label="Luggage"/>
                </q-item>
              </a>
            </q-list>
          </div>
