  ...
  <q-modal ref="modal" content-classes="booking__modal">
    ...
    <div class="row">
      <q-timeline responsive color="secondary" style="padding: 0 24px;">
        <q-timeline-entry v-bind:subtitle="departureDisplayDate" icon="flight_takeoff">
        ...
        <q-timeline-entry v-bind:subtitle="arrivalDisplayDate" icon="flight_land">
          <q-list highlight no-border class="q-pa-none">
            <q-item class="q-pa-none">
      ...
      <div class="booking__modal--ctas booking__modal--highlighted row inline full-width q-pl-lg">
        <div class="col-6">
          <q-btn class="full-width" flat color="primary" label="Check-in"/>
        </div>
        <div class="col-6">
          <q-btn class="full-width" flat color="secondary" label="Cancel booking"/>
        </div>
      </div>
    </div>
  </q-modal>
